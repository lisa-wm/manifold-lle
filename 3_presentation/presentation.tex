...
\begin{itemize}
  ...
  \begin{itemize}
    \flexitem{a} All non-zero entries on diagonal $\Rightarrow$ optimal 
    embedding
    \flexitem{b} Most non-zero entries on upper triangle $\Rightarrow$ close 
    points torn apart
    \flexitem{c} Most non-zero entries on lower triangle $\Rightarrow$ faraway 
    poits collapsed
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \arritem Interpretation.
  \begin{itemize}
    \flexitem{a} $\text{AUC}(R_{NX}) = 0$ $\Rightarrow$ random embedding
    \flexitem{b} $\text{AUC}(R_{NX}) = 1$ $\Rightarrow$ optimal embedding
  \end{itemize}
\end{itemize}
