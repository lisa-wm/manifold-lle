...
\textbf{Graph representation}. Construct skeletal model of the manifold in $\RD$

\vspace{0.15cm}

\begin{minipage}[b]{0.67\textwidth}
  % \begin{itemize}
  %   \arritem \textbf{Vertices.} Given by observations 
  %   \arritem \textbf{Edges.} Present between neighboring points
  %   \begin{itemize} 
