...
\begin{minipage}[b]{0.5\textwidth}
  ...
  vertices and edges indicate neighborhood relations \citep{belkinniyogi2003}.
...
} to be used for finding a low-dimensional embedding, they must be weighted and 
translated into a matrix representation.
