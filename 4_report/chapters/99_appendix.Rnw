...
Consider the rank distances matrices $(r)_{ij}^{\text{obs}}, 
(r)_{ij}^{\text{emb}} \in \R^{N \times N}$, stating for the element in the $i$-th 
row and $j$-th column that the $j$-th observation ranks $(r)_{ij}$ 
...
% \newpage
% \subsection{Qualitative Embedding Results}
% \label{qual_results}
% 
...
%   \caption[]
%   {\raggedright
%   Qualitative results for method of landmark coverage versus number of prior 
%   points -- Swiss roll data.}
% \end{sidewaysfigure}
% 
% \begin{sidewaysfigure}
%   \includegraphics[width = \textwidth]
...
%   \caption[]
%   {\raggedright
%   Qualitative results for noise level versus number of prior points -- Swiss 
%   roll data.}
% \end{sidewaysfigure}
% 
% \begin{sidewaysfigure}
...
%   \caption[]
%   {\raggedright
%   Qualitative results for noise level versus number of prior 
%   points -- incomplete_tire data.}
% \end{sidewaysfigure}