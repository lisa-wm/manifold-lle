...
% Eigenanalysis yields the fundamental information stored in a matrix $\bm{A}$: 
% its principal eigenvectors span a subspace into which the data may be 
% projected under minimal loss of information (with respect to quadratic loss).
% Figure \ref{fig_eigen} depicts the idea of eigenanalysis in a schematic way.
% 
% \begin{figure}[H]
%     \centering
%     \includegraphics[trim = 0 0 0 0, clip, % left bottom right top
%       width = 0.8\textwidth]{figures/eigenanalysis}
%     \caption[]{
%     \raggedright
%     Conceptual idea of eigenanalysis. 
